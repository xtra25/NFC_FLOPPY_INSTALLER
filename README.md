...
## ⚠️ AI Generation & Contribution Disclaimer

This project was developed with significant assistance from AI tools. Please keep the following in mind:

*   **Python Software:** The code was generated by AI and subsequently reviewed by me. However, I haven't actively used Python since completing my vocational training about 10 years ago. Code reviews, refactoring, and pull requests to improve efficiency or security are highly welcome.
*   **Hardware / 3D Modeling:** I have no prior experience with Blender, so I relied entirely on AI to generate the models. However, I have successfully 3D-printed and assembled the parts myself, verifying that the physical assembly works
